...
│   │   ├── council-focus-budget-system (depth 3, TODO)
│   │   ├── action-constraint-validation (depth 3, TODO)
│   │   └── team-action-coordination (depth 3, TODO)
│   └── claim-objective-state-model (depth 2, DONE; expands below)
│       ├── claim-ledger-management (depth 3, TODO)
│       ├── objective-pool-and-rotation (depth 3, TODO)
│       └── public-information-broadcast (depth 3, TODO)
