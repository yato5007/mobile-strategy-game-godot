...
│   │       ├── ffa-final-standings-presentation (depth 4, DONE)
│   │       ├── 2v2-team-standings-presentation (depth 4, DONE)
│   │       └── tie-break-resolution-logic (depth 4, DONE)
│   ├── simultaneous-planning-and-resolution (depth 2, DONE; all depth-4 complete)
│   ├── action-economy-and-legal-actions (depth 2, DONE; all depth-4 complete)
...
├── multiplayer-and-bots (depth 1, DONE; complete through depth 4)
├── balance-and-validation (depth 1, DONE; complete through depth 4)
├── mobile-ux-localization-accessibility (depth 1, DONE; complete through depth 4)
└── godot-architecture-and-delivery (depth 1, DONE; complete through depth 4)
```
