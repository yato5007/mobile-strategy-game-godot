...
│   │   ├── conflict-resolution-engine (depth 3, DONE)
│   │   ├── action-reveal-sequencing (depth 3, DONE)
│   │   └── multi-mode-resolution (depth 3, DONE)
│   ├── action-economy-and-legal-actions (depth 2, DONE; expands below)
│   │   ├── council-focus-budget-system (depth 3, DONE)
│   │   ├── action-constraint-validation (depth 3, DONE)
│   │   └── team-action-coordination (depth 3, DONE)
│   └── claim-objective-state-model (depth 2, DONE; expands below)
│       ├── claim-ledger-management (depth 3, DONE)
│       ├── objective-pool-and-rotation (depth 3, DONE)
│       └── public-information-broadcast (depth 3, DONE)
