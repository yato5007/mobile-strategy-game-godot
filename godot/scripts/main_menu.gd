...
func _ready():
	...
	$BgPanel/TitlePanel/TitleLabel.text = localization.get_string("title")
	$BgPanel/TitlePanel/SubtitleLabel.text = localization.get_string("subtitle")
	_update_mode_labels()

func _update_mode_labels():
	$BgPanel/PlayButton.text = localization.get_string("play") + " ▶"
