# Specification — Strategy Diversity Enforcement
...
1. Players experience strategy diversity, objective variety, adaptive resistance, and repetition detection as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `strategy_diversity_enforcement_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `strategy_diversity_enforcement_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: objective family mix tied to public Claim state and capped for fairness.
14. Planned mechanic: strategy histogram Resource tied to public Claim state and capped for fairness.
15. Planned mechanic: opponent pressure signal tied to public Claim state and capped for fairness.
16. Planned mechanic: repetition warning meter tied to public Claim state and capped for fairness.
