# Specification — Strategy Punishment Detection
...
1. Players experience repetition detection, fair warnings, and non-rubber-band difficulty increases as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `strategy_punishment_detection_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `strategy_punishment_detection_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: strategy repetition score tied to public Claim state and capped for fairness.
14. Planned mechanic: warning Label tied to public Claim state and capped for fairness.
15. Planned mechanic: counter objective spawn tied to public Claim state and capped for fairness.
16. Planned mechanic: balance simulator assertion tied to public Claim state and capped for fairness.
