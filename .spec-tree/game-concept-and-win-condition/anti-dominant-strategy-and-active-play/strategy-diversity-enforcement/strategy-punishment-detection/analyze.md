# Analyze — Strategy Punishment Detection
...
## Balance Analysis
15. The main risk for repetition detection, fair warnings, and non-rubber-band difficulty increases is replacing one dominant strategy with another dominant counter.
