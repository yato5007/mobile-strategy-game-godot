# Specification — Adaptive Opponent Response
...
1. Players experience adaptive opponent response based only on public Claim behavior as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `adaptive_opponent_response_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `adaptive_opponent_response_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: public strategy profile tied to public Claim state and capped for fairness.
14. Planned mechanic: bot response weights tied to public Claim state and capped for fairness.
15. Planned mechanic: Signal strategy_pattern_changed tied to public Claim state and capped for fairness.
16. Planned mechanic: counter pressure marker tied to public Claim state and capped for fairness.
