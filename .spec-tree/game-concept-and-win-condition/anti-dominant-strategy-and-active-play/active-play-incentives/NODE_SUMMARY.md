# NODE_SUMMARY.md — Active Play Incentives

## Purpose
Make active Claim participation consistently better than waiting, hiding, or only reacting at the end.
...
## Child Branches
- `claim-momentum-bonus` complete or planned in this subtree with eight Spec Kit artifacts.
- `idle-penalty-mechanism` complete or planned in this subtree with eight Spec Kit artifacts.
- `engagement-surge-events` complete or planned in this subtree with eight Spec Kit artifacts.
