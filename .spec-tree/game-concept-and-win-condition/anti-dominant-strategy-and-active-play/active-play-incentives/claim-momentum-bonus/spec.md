# Specification — Claim Momentum Bonus
...
1. Players experience capped momentum bonuses that encourage action without creating runaway leaders as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `claim_momentum_bonus_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `claim_momentum_bonus_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: MomentumTimer tied to public Claim state and capped for fairness.
14. Planned mechanic: momentum_state.gd tied to public Claim state and capped for fairness.
15. Planned mechanic: bonus cap Resource tied to public Claim state and capped for fairness.
16. Planned mechanic: Animated token glow tied to public Claim state and capped for fairness.
