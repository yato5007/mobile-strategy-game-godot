...
## Branch Plan
22. Complete child `claim-momentum-bonus` with eight artifacts and concrete future tasks.
23. Complete child `idle-penalty-mechanism` with eight artifacts and concrete future tasks.
24. Complete child `engagement-surge-events` with eight artifacts and concrete future tasks.
