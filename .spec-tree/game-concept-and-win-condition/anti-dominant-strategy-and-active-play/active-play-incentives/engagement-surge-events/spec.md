# Specification — Engagement Surge Events
...
1. Players experience surge events, aggressive Claim windows, and anti-stalling board pressure as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `engagement_surge_events_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `engagement_surge_events_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: SurgeEvent Resource tied to public Claim state and capped for fairness.
14. Planned mechanic: Timer countdown ring tied to public Claim state and capped for fairness.
15. Planned mechanic: Signal surge_started tied to public Claim state and capped for fairness.
16. Planned mechanic: AnimationPlayer pulse tied to public Claim state and capped for fairness.
