# Specification — Idle Penalty Mechanism
...
1. Players experience idle tracking, warning thresholds, and standing decay for passive hiding as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `idle_penalty_mechanism_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `idle_penalty_mechanism_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: IdleTimer tied to public Claim state and capped for fairness.
14. Planned mechanic: idle_warning_card.tscn tied to public Claim state and capped for fairness.
15. Planned mechanic: standing_decay Resource tied to public Claim state and capped for fairness.
16. Planned mechanic: safe planning grace window tied to public Claim state and capped for fairness.
