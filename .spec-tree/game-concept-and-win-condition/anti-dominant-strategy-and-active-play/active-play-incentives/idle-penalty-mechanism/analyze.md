# Analyze — Idle Penalty Mechanism
...
## Balance Analysis
15. The main risk for idle tracking, warning thresholds, and standing decay for passive hiding is replacing one dominant strategy with another dominant counter.
