# Constitution — Active Play Incentives
...
18. Child `claim-momentum-bonus` must complete the same eight Spec Kit artifacts and remain tied to momentum bonuses, idle penalties, and engagement events that reward visible action.
19. Child `idle-penalty-mechanism` must complete the same eight Spec Kit artifacts and remain tied to momentum bonuses, idle penalties, and engagement events that reward visible action.
20. Child `engagement-surge-events` must complete the same eight Spec Kit artifacts and remain tied to momentum bonuses, idle penalties, and engagement events that reward visible action.
