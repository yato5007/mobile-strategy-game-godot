# Analyze — Active Play Incentives
...
## Balance Analysis
15. The main risk for momentum bonuses, idle penalties, and engagement events that reward visible action is replacing one dominant strategy with another dominant counter.
