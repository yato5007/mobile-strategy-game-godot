# Specification — Strategy Shift Incentives
...
1. Players experience visible shift rewards, mode-aware caps, and readable adaptation moments as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `strategy_shift_incentives_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `strategy_shift_incentives_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: ShiftBonus Resource tied to public Claim state and capped for fairness.
14. Planned mechanic: strategy_changed Signal tied to public Claim state and capped for fairness.
15. Planned mechanic: adaptation medal TextureRect tied to public Claim state and capped for fairness.
16. Planned mechanic: phase-aware cap tied to public Claim state and capped for fairness.
