# NODE_SUMMARY.md — Strategy Counterplay Visibility

## Purpose
Expose opponent Claim patterns and counterplay opportunities without turning the game into a table.
...
## Child Branches
- `opponent-claim-pattern-display` complete or planned in this subtree with eight Spec Kit artifacts.
- `counter-strategy-indicator` complete or planned in this subtree with eight Spec Kit artifacts.
- `strategy-shift-incentives` complete or planned in this subtree with eight Spec Kit artifacts.
