# Specification — Strategy Counterplay Visibility
...
1. Players experience readable strategy pattern display, counter indicators, and incentives to shift plans as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `strategy_counterplay_visibility_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `strategy_counterplay_visibility_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: pattern icon strip tied to public Claim state and capped for fairness.
14. Planned mechanic: counter hint card tied to public Claim state and capped for fairness.
15. Planned mechanic: strategy shift bonus tied to public Claim state and capped for fairness.
16. Planned mechanic: public history Signal tied to public Claim state and capped for fairness.
