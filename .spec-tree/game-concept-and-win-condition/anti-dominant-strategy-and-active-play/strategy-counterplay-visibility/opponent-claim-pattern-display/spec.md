# Specification — Opponent Claim Pattern Display
...
1. Players experience portrait pattern display for human-readable counterplay as visible board pressure, not as hidden math.
...
## Godot Data Model
7. Future rules should expose `opponent_claim_pattern_display_state.gd` as typed public state derived from Claim events.
8. Future tuning should use `opponent_claim_pattern_display_rules.tres` Resource data for thresholds, caps, and mode overrides.
...
## Concrete Mechanics
13. Planned mechanic: PatternStrip Control tied to public Claim state and capped for fairness.
14. Planned mechanic: TextureRect claim icons tied to public Claim state and capped for fairness.
15. Planned mechanic: Label localized summary tied to public Claim state and capped for fairness.
16. Planned mechanic: public history buffer tied to public Claim state and capped for fairness.
