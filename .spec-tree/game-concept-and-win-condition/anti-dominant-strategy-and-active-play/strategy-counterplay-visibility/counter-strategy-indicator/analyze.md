# Analyze — Counter Strategy Indicator
...
## Balance Analysis
15. The main risk for counter hints that teach strategy and preserve player agency is replacing one dominant strategy with another dominant counter.
