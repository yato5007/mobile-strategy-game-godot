# NODE_SUMMARY.md — Phase Progression And Tension

## Purpose
Define early, mid, and final match phases so tension escalates naturally without overwhelming mobile players.
...
## Child Branches
- `early-game-ramp-up` complete with 8 planning files.
- `mid-game-intensification` complete with 8 planning files.
- `final-phase-showdown` complete with 8 planning files.
