# NODE_SUMMARY.md — Mid Game Intensification

## Purpose
Define the mid phase where objective count, Claim costs, and tactical intersections increase to create meaningful pressure.
