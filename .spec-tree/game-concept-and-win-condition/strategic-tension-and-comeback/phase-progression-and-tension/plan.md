# Plan — Phase Progression And Tension
...
## Child Work
23. Child `early-game-ramp-up` receives full 8-file artifacts and depth-4 completion where applicable.
23. Child `mid-game-intensification` receives full 8-file artifacts and depth-4 completion where applicable.
23. Child `final-phase-showdown` receives full 8-file artifacts and depth-4 completion where applicable.
