# NODE_SUMMARY.md — Comeback Mechanics And Events

## Purpose
Specify earned comeback mechanics and timed events that let trailing players contest Claim progress through skill, positioning, and resource commitment.
...
## Child Branches
- `catch-up-claim-bonus` complete with 8 planning files.
- `leader-target-pressure` complete with 8 planning files.
- `strategic-reset-points` complete with 8 planning files.
