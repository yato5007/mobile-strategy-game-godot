# NODE_SUMMARY.md — Leader Target Pressure

## Purpose
Define how the near-threshold leader creates public pressure zones that invite all players to contest their route without arbitrary punishment.

## Parent Link
`/workspaces/mobile-strategy-game-godot/.spec-tree/game-concept-and-win-condition/strategic-tension-and-comeback/comeback-mechanics-and-events/`
