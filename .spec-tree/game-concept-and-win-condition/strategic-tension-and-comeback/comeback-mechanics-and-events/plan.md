# Plan — Comeback Mechanics And Events
...
## Child Work
23. Child `catch-up-claim-bonus` receives full 8-file artifacts and depth-4 completion where applicable.
23. Child `leader-target-pressure` receives full 8-file artifacts and depth-4 completion where applicable.
23. Child `strategic-reset-points` receives full 8-file artifacts and depth-4 completion where applicable.
