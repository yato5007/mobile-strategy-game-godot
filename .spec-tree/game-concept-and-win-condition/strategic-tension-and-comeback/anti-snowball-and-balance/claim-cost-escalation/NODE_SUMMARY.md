# NODE_SUMMARY.md — Claim Cost Escalation

## Purpose
Define how each subsequent Claim asks for more strategic effort/resources so early leaders cannot coast to victory.
