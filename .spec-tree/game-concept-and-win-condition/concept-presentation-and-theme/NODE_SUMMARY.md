# Node Summary — Concept Presentation And Theme
...
## Purpose
Define the Arabic-first visual identity, cultural theme, and presentation approach that makes Banner of the Majlis feel like a real strategic mobile game rather than a prototype, spreadsheet, or administrative panel.
...
## Child Branches
- `visual-identity-definition` — Define the core visual language: colors, motifs, iconography, typographic direction, and token vocabulary for the Banner of the Majlis identity.
- `game-space-presentation` — Define the design direction for the play area as a portrait-friendly Majlis board/arena that visualizes Claims as physical game objects, not lists or tables.
- `theme-narrative-framing` — Define the story and framing that make the Claim race cohesive: a council of rival houses competing for honor through visible public commitments.
