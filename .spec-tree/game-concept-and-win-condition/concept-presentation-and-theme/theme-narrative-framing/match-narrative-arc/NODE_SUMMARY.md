# Node Summary — Match Narrative Arc
...
## Purpose
Specify how the visual story of a fixed-length match unfolds from invitation, pledges, contest, reversal, final address, and Claim reveal.
