...
## Specification
1. Primary design outcome: Specify how the visual story of a fixed-length match unfolds from invitation, pledges, contest, reversal, final address, and Claim reveal.
2. Core focus areas: opening ceremony, mid-match escalation, comeback storytelling, final reveal.
