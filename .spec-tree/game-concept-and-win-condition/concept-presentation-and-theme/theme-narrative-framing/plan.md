...
16. Complete `majlis-council-concept` because Specify the premise of tribal or house councils competing for honor in a Majlis gathering, without relying on violent conquest or generic fantasy UI.
17. Complete `match-narrative-arc` because Specify how the visual story of a fixed-length match unfolds from invitation, pledges, contest, reversal, final address, and Claim reveal.
18. Complete `arabic-patronage-naming` because Define naming conventions for objectives, ranks, territories, and patronage titles so Arabic and English localization feels intentional and culturally coherent.
