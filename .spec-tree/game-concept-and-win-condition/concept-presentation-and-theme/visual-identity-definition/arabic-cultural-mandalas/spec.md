...
## Specification
1. Primary design outcome: Specify how Islamic geometric and Arabic cultural mandala-inspired patterns appear as backgrounds, frames, borders, and subtle ornamental feedback without harming play readability.
2. Core focus areas: geometric background tiles, ornamental borders, low-contrast texture layers, legal generated assets.
