# Node Summary — Color Palette Assignment
...
## Purpose
Assign four player colors plus neutral, danger, highlight, and Claim states using an Arabic aesthetic that stays readable on mobile portrait screens.

## Parent Link
`.spec-tree/game-concept-and-win-condition/concept-presentation-and-theme/visual-identity-definition/`
