...
## Specification
1. Primary design outcome: Assign four player colors plus neutral, danger, highlight, and Claim states using an Arabic aesthetic that stays readable on mobile portrait screens.
2. Core focus areas: four player identities, neutral sand and ink, gold Claim highlight, accessibility contrast.
