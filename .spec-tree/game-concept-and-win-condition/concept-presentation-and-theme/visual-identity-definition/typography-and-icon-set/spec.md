...
## Specification
1. Primary design outcome: Define Arabic-first font strategy and icon style guide so labels, objective names, Claim values, and player actions feel crafted rather than hardcoded text panels.
2. Core focus areas: Arabic font hierarchy, English fallback, pictographic icons, localized label discipline.
