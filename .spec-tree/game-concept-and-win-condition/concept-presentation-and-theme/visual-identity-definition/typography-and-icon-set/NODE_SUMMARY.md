# Node Summary — Typography And Icon Set
...
## Purpose
Define Arabic-first font strategy and icon style guide so labels, objective names, Claim values, and player actions feel crafted rather than hardcoded text panels.
