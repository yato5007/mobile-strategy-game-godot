# Node Summary — Game Space Presentation
...
## Purpose
Define the design direction for the play area as a portrait-friendly Majlis board/arena that visualizes Claims as physical game objects, not lists or tables.
...
## Child Branches
- `majlis-board-layout` — Specify the metaphorical gathering-hall board layout where objectives and Claims sit within a readable portrait 2D play space.
- `claim-token-visualization` — Specify how banners, carpets, seals, and tokens visibly show claimed objectives, contested states, leading players, and final Claim strength.
- `spatial-atmosphere-design` — Define ambient background, lighting feel, parallax/depth approach, and shader-friendly mood for a polished 2D Godot portrait presentation.
