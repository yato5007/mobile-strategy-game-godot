# Spec — Claim Token Visualization
...
## Specification
1. Primary design outcome: Specify how banners, carpets, seals, and tokens visibly show claimed objectives, contested states, leading players, and final Claim strength.
2. Core focus areas: banner tokens, woven carpet control, seal stamps, animated contest states.
