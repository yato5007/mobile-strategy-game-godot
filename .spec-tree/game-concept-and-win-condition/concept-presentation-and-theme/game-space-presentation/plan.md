...
16. Complete `majlis-board-layout` because Specify the metaphorical gathering-hall board layout where objectives and Claims sit within a readable portrait 2D play space.
17. Complete `claim-token-visualization` because Specify how banners, carpets, seals, and tokens visibly show claimed objectives, contested states, leading players, and final Claim strength.
18. Complete `spatial-atmosphere-design` because Define ambient background, lighting feel, parallax/depth approach, and shader-friendly mood for a polished 2D Godot portrait presentation.
